        ...
        <div
          ...
          <div className="rounded p-3 flex flex-col sm:flex-row items-center gap-4">
            <div
              ...
              <img
                  className="w-full h-full p-2 rounded-lg aspect-square drop-shadow-md"
            ...
            <div className="w-full h-full flex flex-col items-start justify-between self-start gap-3">
              ...
              <div className="block">
                  <p> 28 year old in Puerto Rico living life to the fullest or whatever. instagram.com/loganpauland 3 more links. Subscribe.</p>
              </div>
